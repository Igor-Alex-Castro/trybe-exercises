...
Faça um programa que, dado um salário bruto, 
...
if(salarioBruto > 0){
    ...
    console.log("Valor inválido, digite um valor maio que 0")
}
...
if(salarioINSS > 0){
    if(salarioINSS <= 1903.98){
        ...
        salarioIR = salarioINSS - (((salarioINSS*7.5)/100)-142.80)
         im = ((salarioINSS*7.5)/100)-142.80
    }
    else if(salarioINSS > 2826.65 && salarioINSS <= 3751.05){
        salarioIR = salarioINSS - ((salarioINSS*15)/100) - 354.80
    }
    else if(salarioINSS > 3751.05 && salarioINSS <= 4664.68){
        salarioIR = salarioINSS - ((salarioINSS*22.5)/100) - 636.13 
    }else{
        salarioIR = salarioINSS - ((salarioINSS*27.5)/100) - 869.36
    }
}

salarioLiq = salarioIR
console.log("Sal liq: " + salarioLiq);